  ...
  <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
    ...
    <div className="relative order-1 lg:order-2 h-[300px] lg:h-auto">
      <MapView pickup={formData.pickup} destination={formData.destination} onRouteCalculated={handleRouteCalculated} updateTrigger={mapUpdateTrigger}/>
    </div>

    {/* Form below on small, left on large */}
    <div className="flex items-center justify-center bg-gray-50 p-8 order-2 lg:order-1">
      {step === 1 && (
        <EstimateForm data={formData} setData={setFormData} nextStep={nextStep}  routeInfo={routeInfo} onTriggerMapUpdate={triggerMapUpdate}/>
      )}
      {step === 2 && (
        <SenderInfoForm
          data={formData}
